    ...
    return <>
        ...
        <div className="container mt-5">
            <div className="row">
                ...
                <p>I proto jsme se rozhodli videa nasdílet veřejně. Nejsou zdaleka v tak fantastické kvalitě, jak bychom si přáli, ale obsah od fantastických lektorů a lektorek z celého světa myslím zprostředkují dostatečně dobře.</p>
                <p><iframe src="https://www.youtube.com/embed/18UgkCW3mj8" frameborder="0" width="560" height="315"></iframe></p>
                <p>Vím, že výzev na dobrovolné přispívání jste zřejmě době nouzové dostali hodně, nicméně i my k nim jednu přidáme a věříme, že není nijak troufalá. Jedno DVD se nacenilo v minulosti na 190,- a v průměru má stopáž 3 hodiny. Celkem nyní uvolníme cca 18 hodin video materiálu.</p>
                <p>Pokud byste se rozhodli přispět a ocenit tak dny a noci strávené při jejich úpravě a výrobě, budeme nejen vděční, ale už i víme, jak bychom peníze použili:
                    <ul>
                        <li>k možnosti slevit peer účastníkům účast na budoucích kurzech a workshopech</li>
                        <li>k vydání a překladu Kroniky Narativu - materiálu, jenž nám dál pomůže v propagaci a získávání grantů na nejrůznější projekty, díky čemuž můžeme dál dělat naše akce přístupné co nejširší skupině lidí</li>
                ...
                <p>Sylvia London: Šikana, přestaňme o ní mluvit, začněme mluvit spolu. Záznam z workshopu z listopadu 2015 v Brně.</p>
                </div>
            </div>
        </div>
    </>
